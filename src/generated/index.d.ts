...
export namespace Prisma {
  ...
  */
  ...
  export type ComentariosOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "texto" | "nomeUsuario", ExtArgs["result"]["comentarios"]>
  ...
  export interface ComentariosDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const comentariosWithIdOnly = await prisma.comentarios.createManyAndReturn({
     *   select: { id: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * const comentariosWithIdOnly = await prisma.comentarios.updateManyAndReturn({
     *   select: { id: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface ComentariosFieldRefs {
    ...
    readonly nomeUsuario: FieldRef<"Comentarios", 'String'>
  }
  ...
  export type ComentariosWhereInput = {
    ...
    nomeUsuario?: StringFilter<"Comentarios"> | string
  }
  ...
  export type ComentariosScalarWhereWithAggregatesInput = {
    ...
    nomeUsuario?: StringWithAggregatesFilter<"Comentarios"> | string
  }
